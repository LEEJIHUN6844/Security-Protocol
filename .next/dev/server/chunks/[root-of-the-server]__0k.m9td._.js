...
// 🚨 런타임 메모리에 보안 환경변수가 제대로 적재되었는지 터미널에 강제 출력
console.log("=== NextAuth 보안 설정 적재 확인 ===");
console.log("1. GITHUB_ID:", process.env.AUTH_GITHUB_ID ? "정상 로드됨" : "❌ NULL (값 없음)");
console.log("2. GITHUB_SECRET:", process.env.AUTH_GITHUB_SECRET ? "정상 로드됨" : "❌ NULL (값 없음)");
console.log("3. AUTH_SECRET:", process.env.AUTH_SECRET ? "정상 로드됨" : "❌ NULL (값 없음)");
console.log("==================================");
const { handlers, auth, signIn, signOut } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])({
    ...
    providers: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$providers$2f$github$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            // 환경변수를 강제로 주입하여 라이브러리의 자동 탐지 오류를 방지합니다.
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0k.m9td._.js.map