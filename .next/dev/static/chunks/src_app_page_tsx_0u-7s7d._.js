...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$node$2d$forge$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/node-forge/lib/index.js [app-client] (ecmascript)");
;
...
function Home() {
    ...
    // 전자봉투 관련 상태
    const [targetUsers, setTargetUsers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [selectedReceiver, setSelectedReceiver] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [envelopeBody, setEnvelopeBody] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const [certDetails, setCertDetails] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // 데이터 로딩 (수신자 목록 및 수신함)
    ...
    const handleIssueCert = async ()=>{
        ...
        setTimeout(async ()=>{
            try {
                const keypair = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$node$2d$forge$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].pki.rsa.generateKeyPair(2048);
                const publicKeyPem = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$node$2d$forge$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].pki.publicKeyToPem(keypair.publicKey);
                const privateKeyPem = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$node$2d$forge$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].pki.privateKeyToPem(keypair.privateKey);
    ...
    const handleSignatureLogin = async ()=>{
        ...
        try {
            ...
            const pki = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$node$2d$forge$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].pki;
            const privateKey = pki.privateKeyFromPem(privateKeyPem);
            const time = new Date().getTime().toString();
            const messageToSign = session.user.email + time;
            const md = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$node$2d$forge$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].md.sha256.create();
            md.update(messageToSign, 'utf8');
            const signature = privateKey.sign(md);
            const signatureHex = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$node$2d$forge$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].util.bytesToHex(signature);
    ...
    const handleSendEnvelope = async ()=>{
        ...
        try {
            ...
            const aesKey = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$node$2d$forge$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].random.getBytesSync(32);
            const iv = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$node$2d$forge$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].random.getBytesSync(16);
            // (3) 본문 암호화 (메시지 + 서명)
            const dataToEncrypt = JSON.stringify({
                content: envelopeBody,
                signature: signatureHex
            });
            const cipher = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$node$2d$forge$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].cipher.createCipher('AES-CBC', aesKey);
            cipher.start({
                iv: iv
            });
            cipher.update(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$node$2d$forge$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].util.createBuffer(dataToEncrypt, 'utf8'));
            cipher.finish();
            const encryptedContent = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$node$2d$forge$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].util.bytesToHex(cipher.output.getBytes());
            // (4) 전자봉투 생성 (AES 키를 수신자 공개키로 RSA 암호화)
            const encryptedKey = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$node$2d$forge$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].util.bytesToHex(receiverPublicKey.encrypt(aesKey));
            // (5) 서버로 전송
            const res = await fetch('/api/messages/send', {
                ...
                body: JSON.stringify({
                    ...
                    encryptedContent,
                    encryptedKey,
                    iv: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$node$2d$forge$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].util.bytesToHex(iv)
                })
            });
            if (res.ok) {
    ...
    const handleOpenEnvelope = async (msg)=>{
        ...
        try {
            ...
            const encryptedKeyBytes = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$node$2d$forge$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].util.hexToBytes(msg.encryptedKey);
            const aesKey = privateKey.decrypt(encryptedKeyBytes);
            // (2) 획득한 AES 키로 본문 복호화
            const iv = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$node$2d$forge$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].util.hexToBytes(msg.iv);
            const encryptedBytes = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$node$2d$forge$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].util.hexToBytes(msg.encryptedContent);
            const decipher = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$node$2d$forge$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].cipher.createDecipher('AES-CBC', aesKey);
            decipher.start({
                iv: iv
            });
            decipher.update(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$node$2d$forge$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].util.createBuffer(encryptedBytes));
            decipher.finish();
            ...
            const verified = senderPublicKey.verify(md.digest().bytes(), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$node$2d$forge$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].util.hexToBytes(signature));
            if (verified) {
                alert(`🔓 복호화 및 검증 성공!\n\n보낸이: ${msg.senderName}\n메시지: ${content}\n(서명 일치 확인됨)`);
            } else {
                        ...
                        children: [
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                        ...
                                                        children: [
                                                            ...
                                                            targetUsers.map((u)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                    value: u.email,
                                                                    children: [
                                                                        u.name,
                                                                        " (",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "space-y-3",
                                        children: receivedMessages.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            lineNumber: 368,
                                            columnNumber: 19
                                        }, this) : receivedMessages.map((msg)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                                ...
                                children: [
                                    ...
                                    certDetails && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                    ...
                                                    ].map(([label, value])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
...
_s(Home, "DAiI5yRgX7ik+i/C+HgMn05Icgw=", false, function() {
    return [
